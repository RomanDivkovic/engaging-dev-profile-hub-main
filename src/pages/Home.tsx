          ...
          >
            <div className="mb-8">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto">
                I'm a fullstack developer specializing in React, React Native, and Firebase. I build
                user-centered solutions with modern technology and passion.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="text-muted-foreground">
              I focus on optimized solutions that load quickly and run smoothly, ensuring the best
          ...
          <div className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="text-muted-foreground">
              All applications are designed to work flawlessly on any device, from mobile phones to
          ...
          <div className="bg-card rounded-lg p-6 shadow-sm">
            ...
            <p className="text-muted-foreground">
              I stay updated with the latest technologies and security practices to ensure your
              applications are both cutting-edge and secure.
            </p>
          </div>
        </div>
      </Section>
